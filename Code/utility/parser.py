...
def parse_args():
    ...
    parser.add_argument('--model_type', nargs='?', default='bprmf',
                        help='Specify the name of model (bprmf, bprmf_V, bprmf_F, bprmf_neural).')
    ...
    parser.add_argument('--regs', nargs='?', default='[1e-2,1e-5,1e-5]',
    ...
    parser.add_argument('--Ks', nargs='?', default='[20, 40, 60, 80]',
                        help='Output sizes of every layer')
